...
public class ExperimentalProjectTest {

    private ExperimentalProject project;
    private ExperimentalProject filmProject;

    @BeforeEach
    public void setUp() {
        project =
            new ExperimentalProject(
                "test-project",
                "Test Project",
                new ProjectImage(
    ...
    public void testProjectCanLoadFromJson() throws IOException {
            ...
            """
        {
          ...
          "name": "Test Project",
          "icon": {
            "path": "experiments/my_brain/main",
            "ext": "JPG",
            "alt": "test icon"
          },
          "links": [
        ...
        """;
        ExperimentalProject pojoProject = objectMapper.readValue(
            jsonProject,
