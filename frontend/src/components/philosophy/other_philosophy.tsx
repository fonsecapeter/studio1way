...
import made4SkateboardingPath50 from "../../assets/img/web/other/made_4_skateboarding/50.jpg";
import nodToVirgilPath50 from "../../assets/img/web/other/nod_to_virgil/50.jpg";
import whiteShoePath50 from "../../assets/img/web/other/white_shoe/50.jpg";
import made4SkateboardingPath100 from "../../assets/img/web/other/made_4_skateboarding/100.jpg";
import nodToVirgilPath100 from "../../assets/img/web/other/nod_to_virgil/100.jpg";
import whiteShoePath100 from "../../assets/img/web/other/white_shoe/100.jpg";
