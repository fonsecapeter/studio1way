...
type OtherProjectDetailContainerParams = {
  projectId: string;
};

export const OtherProjectDetailContainer = () => {
  const { projectId } = useParams<OtherProjectDetailContainerParams>();
  const { loading, error, data } = useQuery(OTHER_PROJECT_BY_ID, {
    variables: { projectId },
  });
...
export default OtherProjectDetailContainer;
